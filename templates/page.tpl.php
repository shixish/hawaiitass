...
<div id="page">
  <?php if ($is_front): ?>
  <?php if (theme_get_setting('slideshow_display','hawaiitass')): ?>
  <?php 
    $slide1_head = check_plain(theme_get_setting('slide1_head','hawaiitass'));   $slide1_desc = check_markup(theme_get_setting('slide1_desc','hawaiitass'), 'full_html'); $slide1_url = check_plain(theme_get_setting('slide1_url','hawaiitass'));
    $slide2_head = check_plain(theme_get_setting('slide2_head','hawaiitass'));   $slide2_desc = check_markup(theme_get_setting('slide2_desc','hawaiitass'), 'full_html'); $slide2_url = check_plain(theme_get_setting('slide2_url','hawaiitass'));
    $slide3_head = check_plain(theme_get_setting('slide3_head','hawaiitass'));   $slide3_desc = check_markup(theme_get_setting('slide3_desc','hawaiitass'), 'full_html'); $slide3_url = check_plain(theme_get_setting('slide3_url','hawaiitass'));
  ?>
  <div id="slidebox" class="flexslider">
    <ul class="slides">
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'hawaiitass') . '/images/slide-image-1.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'hawaiitass') . '/images/slide-image-2.jpg'; ?>"/>
      ...
      <li>
        <img src="<?php print base_path() . drupal_get_path('theme', 'hawaiitass') . '/images/slide-image-3.jpg'; ?>"/>
